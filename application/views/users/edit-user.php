<div class="content-wrapper">
	<section class="content-header">
		<h1> Master <small>Edit User</small> </h1>
		<ol class="breadcrumb">
			...
			<div class="col-md-6">
				<div class="panel">
					...
					<div class="panel-body">
						<form action="<?= base_url('admin/updateAdmin') ?>" enctype="multipart/form-data" method="POST" id="upload">
...
<script type="text/javascript">
	...
	function loaddata() {
		var t = $("#mytable").dataTable({
			...
			processing: true,
			serverSide: true,
			ajax: {"url": "<?= base_url('admin/json_activity') ?>/<?= $user_data['id'] ?>", "type": "POST"},
			columns: [
