...
$action = base_url('gallery/store');

if($data_edit){
  $action = base_url('gallery/update/'.$data_edit['id']);
}
...
<form method="POST" action="<?= $action ?>" id="upload-create" enctype="multipart/form-data" class="form-horizontal">
            ...
            <table class="table table-bordered" style="width: 100%">
              ...
              <tbody id="detail_image_open">
                ...
                foreach($file_detail as $img){
                  ...
                  <tr id="detail_image_edit">
                    ...
                    <td>
                      <?php if($img['status']=='ENABLE'){?>
                        <a href="<?= base_url('gallery/status/').$img['id'] ?>/DISABLE">
                          <button type="button" class="btn btn-sm btn-sm btn-success">
                            <i class="fa fa-check-circle"></i> ENABLE
                          </button>
                        </a>
                      <?php }else { ?>
                        <a href="<?= base_url('gallery/status/').$img['id'] ?>/ENABLE">
                    ...
                    <td>
                      <a href="<?= base_url('gallery/editImage/').$img['id']?>">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body" align="center">
                              ...
                              <div class="box-footer" align="center">
                                ...
                                <a href="<?= base_url('gallery/delete_image/'.$img['id'])?>">
              ...
              <tfoot>
                <td colspan="3" align="center" id="btn_image_add">
                  <a href="<?= base_url('gallery/addOneImage/').$data_edit['id']?>">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body" align="center">
                    ...
                    <div class="box-footer" align="center">
                      ...
                      <a href="<?= base_url('gallery/delete_Allimage/'.$data_edit['id'])?>">
                        <button type="button" class="btn btn-danger btn-send" ><i class="fa fa-trash"></i> Hapus</button>
                      </a>
                    </div>
                  </div>
  ...
  <div class="box-footer" align="right">
    <a href="<?= base_url('event') ?> ">
      <button type="button" class="btn btn-info"><i class="fa fa-picture-o"></i> Data Gallery</button>
    </a>
    <?php if($data_edit){ ?>
      <button type="submit" class="btn btn-primary btn-send" ><i class="fa fa-edit"></i> Save</button>
    <?php } else { ?>
