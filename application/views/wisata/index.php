 <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="pull-right">
                  <a href="<?= base_url('wisata/create') ?>">
                    <button type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah Wisata</button>
                  </a>
                </div>
              </div>
            </div>
                  ...
                  $i = 1; foreach ($tbl_wisata as $row) {
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php }else { ?>
                          <a href="<?= base_url('wisata/status/').$row['id'] ?>/ENABLE">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" tbl_wisata="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <form id="upload-delete" action="<?= base_url('wisata/delete') ?>" method="POST">
  ...
  <script type="text/javascript">
    ...
    function edit(id) {
      location.href = "<?= base_url('wisata/edit/') ?>"+id;
    }
